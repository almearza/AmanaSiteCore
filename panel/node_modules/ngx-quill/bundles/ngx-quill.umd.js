...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(QuillService, [{
    ...
    QuillService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function QuillService_Factory() { return new QuillService(i0__namespace.ɵɵinject(QUILL_CONFIG_TOKEN)); }, token: QuillService, providedIn: "root" });
    ...
    var QuillEditorBase = /** @class */ (function () {
        ...
        QuillEditorBase.prototype.ngOnDestroy = function () {
            ...
            if (this.quillEditor) {
                ...
                this.debounceTimers.forEach(function (timer) { return _this.clearDebounceTimer(timer); });
            }
        };
        ...
        QuillEditorBase.prototype.debounce = function (callback) {
            var _this = this;
            var timer;
            return function () {
                var args = [];
                ...
                if (typeof _this.debounceTime !== 'number') {
                    callback.apply(void 0, __spreadArray([], __read(args)));
                    return;
                }
                _this.clearDebounceTimer(timer);
                timer = _this.doc.defaultView.setTimeout(function () {
                    _this.clearDebounceTimer(timer);
                    callback.apply(void 0, __spreadArray([], __read(args)));
                }, _this.debounceTime);
                _this.debounceTimers.push(timer);
            };
        };
        QuillEditorBase.prototype.clearDebounceTimer = function (timer) {
            this.doc.defaultView.clearTimeout(timer);
            this.debounceTimers = this.debounceTimers.filter(function (debounceTimer) { return debounceTimer !== timer; });
        };
